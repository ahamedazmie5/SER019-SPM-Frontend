...
export default class ViewHotelDetails extends Component {
  ...
  retrievePosts() {
    axios
      .get("http://localhost:8080/travelgo/packages/getAllHotelPackages")
      .then((res) => {
  ...
  onDelete = (finalid) => {
    axios
      .delete(
        `http://localhost:8080/travelgo/packages/RemoveHotelPackages/${finalid}`
      )
      .then((res) => {
        ...
        <nav className="navbar navbar-expand-lg navbar-light bg-light">
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              >
                <b>
                  <a className="nav-link" href="/ViewHotelDetails">
            ...
            <tbody>
              {this.state.posts.map((post, index) => (
                <tr key={index}>
                  ...
                  <td>
                    <a
                      href={`/HotelPackageDetails/${post._id}`}
                  ...
                  <td style={{ width: "200px" }}>
                    <a
                      ...
                      href={`/UpdateHotelDetails/${post._id}`}
                    >
