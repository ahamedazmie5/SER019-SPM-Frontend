...
export default class AddHotelPackages extends Component {
  ...
  onSubmit = (e) => {
    ...
    axios
      .post("http://localhost:8080/travelgo/packages/createHotelPackages", data)
      .then((res) => {
          ...
          <nav className="navbar navbar-expand-lg navbar-light bg-light">
            ...
            >
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                >
                  <b>
                    <a
                      ...
                      aria-current="page"
                      href="/AddHotelPackages"
                    >
                      <h5>Add New Hotel Packages</h5>
                    </a>
                  </b>
                </li>
                <li
                ...
                >
                  <b>
                    <a className="nav-link" href="/UpdateHotelDetails/:id">
                      <h5>Update Hotel Details</h5>
                    </a>
                  </b>
                </li>
                <li
                ...
                >
                  <b>
                    <a className="nav-link" href="/ReservationDailySummary">
                      <h5>Reservation Daily Summary</h5>
                    </a>
                  </b>
                </li>
              </ul>
                ...
                <tr>
                  <th>
                    <center>
                      ...
                      >
                        <label
                          style={{ marginBottom: "10px", marginRight: "35px" }}
                        >
                          Single Room Price :
                        </label>
                        <input
                      ...
                      >
                        <label
                          style={{ marginBottom: "10px", marginRight: "25px" }}
                        >
                          Double_Room_Price :
                        </label>
                        <input
                      ...
                      >
                        <label
                          style={{ marginBottom: "10px", marginRight: "70px" }}
                        >
                          Hotel Contact :
                        </label>
                        <input
                      ...
                      >
                        <label
                          style={{ marginBottom: "10px", marginRight: "110px" }}
                        >
                          Location :
                        </label>
                        <input
