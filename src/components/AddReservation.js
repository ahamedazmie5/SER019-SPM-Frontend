...
export default class AddReservation extends Component {
  ...
  onSubmit = (e) => {
    ...
    axios
      .post(
        "http://localhost:8080/travelgo/packages/createHotelReservation",
        data
      )
      .then((res) => {
          ...
          <nav className="navbar navbar-expand-lg navbar-light bg-light">
            ...
            >
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                >
                  <b>
                    <a
                      className="nav-link"
                      aria-current="page"
                      href="/CusViewHotelDetails"
                    >
                      <h5>View All Hotels Packages</h5>
                    </a>
                  </b>
                </li>
                <li
                ...
                >
                  <b>
                    <a className="nav-link" href="/UpdateReservation/:id">
                      <h5>Update Reservation Details</h5>
                    </a>
                  </b>
                </li>
                <li
                ...
                >
                  <b>
                    <a className="nav-link" href="/edit1/:id">
                      <h5>Delete Reservation Details</h5>
                    </a>
                  </b>
                </li>
              </ul>
                ...
                <tr>
                  <th>
                    <center>
                      ...
                      >
                        <label
                          style={{ marginBottom: "10px", marginRight: "75px" }}
                        >
                          Contact Number :
                        </label>
                        <input
                      ...
                      >
                        <label
                          style={{ marginBottom: "10px", marginRight: "95px" }}
                        >
                          Check_In_Date :
                        </label>
                        <input
                      ...
                      >
                        <label
                          style={{ marginBottom: "10px", marginRight: "117px" }}
                        >
                          Room Type :
                        </label>
                        <input
